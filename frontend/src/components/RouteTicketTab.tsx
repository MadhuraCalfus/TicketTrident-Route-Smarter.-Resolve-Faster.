...
import { api } from "../api";
import type { SampleTicket, TicketResult } from "../types";
    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_1fr]">
      <Card className="p-5">
        ...
        <textarea
          ...
          rows={6}
          className="mt-4 w-full resize-none rounded-xl border border-black/10 dark:border-white/15 bg-black/[0.02] dark:bg-white/[0.03] p-3 text-sm outline-none focus:border-brand/60 focus:ring-2 focus:ring-brand/20"
        />
